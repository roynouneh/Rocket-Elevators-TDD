class BatteriesController < ApplicationController
  ...
  private
    ...
    def battery_params
      params.require(:battery).permit(:building_id, :building_type, :status, :employee_id, :commission_date, :last_inspection, :certificate_of_operations, :information, :notes)
    end
end
