...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post columns_url, params: { column: { battery_id: @column.battery_id, information: @column.information, notes: @column.notes, number_of_floors_served: @column.number_of_floors_served, status: @column.status, type: @column.type } }
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { battery_id: @column.battery_id, information: @column.information, notes: @column.notes, number_of_floors_served: @column.number_of_floors_served, status: @column.status, type: @column.type } }
